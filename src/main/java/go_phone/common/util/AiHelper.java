...
public class AiHelper {
    ...
    public String buildHelpPrompt(HelpRequest r, String normalizedMsg) {
        ...
        sb.append("Yêu cầu hỗ trợ từ khách hàng:\n")
                .append("- Họ tên/username: ").append(safe(r.username())).append('\n')
                .append("- Email: ").append(safe(r.email())).append('\n')
                .append("- Loại: ").append(Objects.toString(r.type(), "GENERAL")).append('\n')
                .append("- Kênh: ").append(Objects.toString(r.channel(), "WEB")).append('\n')
                .append("- Chủ đề: ").append(safe(r.subject())).append('\n')
                .append("- Nội dung: ").append(normalizedMsg).append('\n');
